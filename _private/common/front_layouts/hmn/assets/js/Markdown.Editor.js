...
(function () {
    ...
    Markdown.Editor = function (markdownConverter, idPostfix, help, content_id) {
        ...
        this.run = function () {
            ...
            panels = new PanelCollection(idPostfix,content_id);
    ...
    function PanelCollection(postfix,content_id) {
        ...
        if(content_id==''){
        	...
        	this.input = doc.getElementById(content_id);
        }
